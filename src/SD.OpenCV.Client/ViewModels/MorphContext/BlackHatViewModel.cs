...
namespace SD.OpenCV.Client.ViewModels.MorphContext
{
    ...
    /// 黑帽运算视图模型
    /// </summary>
    public class BlackHatViewModel : PreviewViewModel
    {
        #region # 字段及构造器
        ...
        /// 依赖注入构造器
        /// </summary>
        public BlackHatViewModel(IWindowManager windowManager)
        {
        ...
        public async void Apply()
        {
            ...
            using Mat result = await Task.Run(() => this.Image.MorphBlackHat(this.KernelSize!.Value));
