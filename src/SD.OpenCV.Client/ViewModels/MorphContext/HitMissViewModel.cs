...
namespace SD.OpenCV.Client.ViewModels.MorphContext
{
    ...
    /// 击否运算视图模型
    /// </summary>
    public class HitMissViewModel : PreviewViewModel
    {
        #region # 字段及构造器
        ...
        /// 依赖注入构造器
        /// </summary>
        public HitMissViewModel(IWindowManager windowManager)
        {
        ...
        public async void Apply()
        {
            ...
            using Mat grayImage = this.Image.Type() == MatType.CV_8UC3
                ...
                : this.Image.Clone();
            using Mat result = await Task.Run(() => grayImage.MorphHitMiss(this.KernelSize!.Value));
