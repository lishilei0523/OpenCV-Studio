...
namespace SD.OpenCV.Client.ViewModels.MorphContext
{
    ...
    /// 开运算视图模型
    /// </summary>
    public class OpenViewModel : PreviewViewModel
    {
        #region # 字段及构造器
        ...
        /// 依赖注入构造器
        /// </summary>
        public OpenViewModel(IWindowManager windowManager)
        {
        ...
        public async void Apply()
        {
            ...
            using Mat result = await Task.Run(() => this.Image.MorphOpen(this.KernelSize!.Value));
