...
namespace SD.OpenCV.Client.ViewModels.MorphContext
{
    ...
    /// 膨胀视图模型
    /// </summary>
    public class DilateViewModel : PreviewViewModel
    {
        #region # 字段及构造器
        ...
        /// 依赖注入构造器
        /// </summary>
        public DilateViewModel(IWindowManager windowManager)
        {
        ...
        public async void Apply()
        {
            ...
            using Mat result = await Task.Run(() => this.Image.MorphDilate(this.KernelSize!.Value));
