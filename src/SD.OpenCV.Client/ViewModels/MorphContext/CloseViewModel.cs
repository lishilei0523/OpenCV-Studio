...
namespace SD.OpenCV.Client.ViewModels.MorphContext
{
    ...
    /// 闭运算视图模型
    /// </summary>
    public class CloseViewModel : PreviewViewModel
    {
        #region # 字段及构造器
        ...
        /// 依赖注入构造器
        /// </summary>
        public CloseViewModel(IWindowManager windowManager)
        {
        ...
        public async void Apply()
        {
            ...
            using Mat result = await Task.Run(() => this.Image.MorphClose(this.KernelSize!.Value));
