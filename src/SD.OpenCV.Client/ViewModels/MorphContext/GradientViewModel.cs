...
namespace SD.OpenCV.Client.ViewModels.MorphContext
{
    ...
    /// 梯度运算视图模型
    /// </summary>
    public class GradientViewModel : PreviewViewModel
    {
        #region # 字段及构造器
        ...
        /// 依赖注入构造器
        /// </summary>
        public GradientViewModel(IWindowManager windowManager)
        {
        ...
        public async void Apply()
        {
            ...
            using Mat result = await Task.Run(() => this.Image.MorphGradient(this.KernelSize!.Value));
