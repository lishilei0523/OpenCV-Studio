...
namespace SD.OpenCV.Client.ViewModels.SpaceBlurContext
{
    ...
    /// 中值滤波视图模型
    /// </summary>
    public class MedianViewModel : PreviewViewModel
    {
        #region # 字段及构造器
        ...
        /// 依赖注入构造器
        /// </summary>
        public MedianViewModel(IWindowManager windowManager)
        {
        ...
        public async void Apply()
        {
            ...
            await Task.Run(() => Cv2.MedianBlur(this.Image, result, this.KernelSize!.Value));
