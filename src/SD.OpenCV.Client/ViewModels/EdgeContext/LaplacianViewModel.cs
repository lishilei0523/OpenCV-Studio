...
namespace SD.OpenCV.Client.ViewModels.EdgeContext
{
    ...
    /// Laplacian边缘检测视图模型
    /// </summary>
    public class LaplacianViewModel : PreviewViewModel
    {
        #region # 字段及构造器
        ...
        /// 依赖注入构造器
        /// </summary>
        public LaplacianViewModel(IWindowManager windowManager)
        {
        ...
        public async void Apply()
        {
            ...
            using Mat result = await Task.Run(() => this.Image.ApplyLaplacian(this.KernelSize!.Value));
