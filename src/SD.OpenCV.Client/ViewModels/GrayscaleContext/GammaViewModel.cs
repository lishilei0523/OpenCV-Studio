...
namespace SD.OpenCV.Client.ViewModels.GrayscaleContext
{
    ...
    /// 伽马变换视图模型
    /// </summary>
    public class GammaViewModel : PreviewViewModel
    {
        #region # 字段及构造器
        ...
        /// 依赖注入构造器
        /// </summary>
        public GammaViewModel(IWindowManager windowManager)
        {
        ...
        public async void Apply()
        {
            ...
            using Mat result = await Task.Run(() => this.Image.GammaTransform(this.Gamma!.Value));
