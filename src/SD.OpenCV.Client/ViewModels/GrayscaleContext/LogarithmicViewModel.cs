...
namespace SD.OpenCV.Client.ViewModels.GrayscaleContext
{
    ...
    /// 对数变换视图模型
    /// </summary>
    public class LogarithmicViewModel : PreviewViewModel
    {
        #region # 字段及构造器
        ...
        /// 依赖注入构造器
        /// </summary>
        public LogarithmicViewModel(IWindowManager windowManager)
        {
        ...
        public async void Apply()
        {
            ...
            using Mat result = await Task.Run(() => this.Image.LogarithmicTransform(this.Gamma!.Value));
