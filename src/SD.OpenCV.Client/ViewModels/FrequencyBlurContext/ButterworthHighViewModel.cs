...
namespace SD.OpenCV.Client.ViewModels.FrequencyBlurContext
{
    ...
    /// 巴特沃斯高通滤波视图模型
    /// </summary>
    public class ButterworthHighViewModel : PreviewViewModel
    {
        #region # 字段及构造器
        ...
        /// 依赖注入构造器
        /// </summary>
        public ButterworthHighViewModel(IWindowManager windowManager)
        {
        ...
        public async void Apply()
        {
            ...
            using Mat result = await Task.Run(() => this.Image.ButterworthHPBlur(this.Sigma!.Value, this.N!.Value));
