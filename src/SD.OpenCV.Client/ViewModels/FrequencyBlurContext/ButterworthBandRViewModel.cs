...
namespace SD.OpenCV.Client.ViewModels.FrequencyBlurContext
{
    ...
    /// 巴特沃斯带阻滤波视图模型
    /// </summary>
    public class ButterworthBandRViewModel : PreviewViewModel
    {
        #region # 字段及构造器
        ...
        /// 依赖注入构造器
        /// </summary>
        public ButterworthBandRViewModel(IWindowManager windowManager)
        {
        ...
        public async void Apply()
        {
            ...
            using Mat result = await Task.Run(() => this.Image.ButterworthBRBlur(this.Sigma!.Value, this.BandWidth!.Value, this.N!.Value));
