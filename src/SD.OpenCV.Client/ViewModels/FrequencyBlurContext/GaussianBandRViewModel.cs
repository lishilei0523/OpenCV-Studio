...
namespace SD.OpenCV.Client.ViewModels.FrequencyBlurContext
{
    ...
    /// 高斯带阻滤波视图模型
    /// </summary>
    public class GaussianBandRViewModel : PreviewViewModel
    {
        #region # 字段及构造器
        ...
        /// 依赖注入构造器
        /// </summary>
        public GaussianBandRViewModel(IWindowManager windowManager)
        {
        ...
        public async void Apply()
        {
            ...
            using Mat result = await Task.Run(() => this.Image.GaussianBRBlur(this.Sigma!.Value, this.BandWidth!.Value));
