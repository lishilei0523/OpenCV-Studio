...
namespace SD.OpenCV.Client.ViewModels.FrequencyBlurContext
{
    ...
    /// 巴特沃斯低通滤波视图模型
    /// </summary>
    public class ButterworthLowViewModel : PreviewViewModel
    {
        #region # 字段及构造器
        ...
        /// 依赖注入构造器
        /// </summary>
        public ButterworthLowViewModel(IWindowManager windowManager)
        {
        ...
        public async void Apply()
        {
            ...
            using Mat result = await Task.Run(() => this.Image.ButterworthLPBlur(this.Sigma!.Value, this.N!.Value));
