...
namespace SD.OpenCV.Client.ViewModels.FrequencyBlurContext
{
    ...
    /// 理想低通滤波视图模型
    /// </summary>
    public class IdealLowViewModel : PreviewViewModel
    {
        #region # 字段及构造器
        ...
        /// 依赖注入构造器
        /// </summary>
        public IdealLowViewModel(IWindowManager windowManager)
        {
        ...
        public async void Apply()
        {
            ...
            using Mat result = await Task.Run(() => this.Image.IdealLPBlur(this.Sigma!.Value));
