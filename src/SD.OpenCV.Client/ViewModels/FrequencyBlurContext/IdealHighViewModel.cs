...
namespace SD.OpenCV.Client.ViewModels.FrequencyBlurContext
{
    ...
    /// 理想高通滤波视图模型
    /// </summary>
    public class IdealHighViewModel : PreviewViewModel
    {
        #region # 字段及构造器
        ...
        /// 依赖注入构造器
        /// </summary>
        public IdealHighViewModel(IWindowManager windowManager)
        {
        ...
        public async void Apply()
        {
            ...
            using Mat result = await Task.Run(() => this.Image.IdealHPBlur(this.Sigma!.Value));
