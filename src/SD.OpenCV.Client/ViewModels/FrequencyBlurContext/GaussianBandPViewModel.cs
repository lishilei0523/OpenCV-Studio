...
namespace SD.OpenCV.Client.ViewModels.FrequencyBlurContext
{
    ...
    /// 高斯带通滤波视图模型
    /// </summary>
    public class GaussianBandPViewModel : PreviewViewModel
    {
        #region # 字段及构造器
        ...
        /// 依赖注入构造器
        /// </summary>
        public GaussianBandPViewModel(IWindowManager windowManager)
        {
        ...
        public async void Apply()
        {
            ...
            using Mat result = await Task.Run(() => this.Image.GaussianBPBlur(this.Sigma!.Value, this.BandWidth!.Value));
