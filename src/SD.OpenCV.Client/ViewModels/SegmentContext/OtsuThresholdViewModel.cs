...
namespace SD.OpenCV.Client.ViewModels.SegmentContext
{
    ...
    /// OTSU阈值分割视图模型
    /// </summary>
    public class OtsuThresholdViewModel : PreviewViewModel
    {
        #region # 字段及构造器
        ...
        /// 依赖注入构造器
        /// </summary>
        public OtsuThresholdViewModel(IWindowManager windowManager)
        {
        ...
        public async void Apply()
        {
            ...
            await Task.Run(() => Cv2.Threshold(this.Image, result, 0, 255, this.ThresholdType | OpenCvSharp.ThresholdTypes.Otsu));
